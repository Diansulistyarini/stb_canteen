...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">DataTables Menu
                <span>
                    <a href="/makanan/create" class="text-primary float-right">
                        <i class="fas fa-plus"><span class="ml-2">Tambah Menu</span></i>
                    </a>
                </span>
            </h6>
        </div>
                ...
                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th scope="col" class="text-center">Stok Menu</th>
                            <th scope="col" class="text-center">Gambar Menu</th>
