...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary text-center">Edit Menu</h6>
        </div>
        <div class="card-body">
            <form class=" form-signin" action="/makanan/{{ $makanan->id_makanan }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nama_makanan') is-invalid @enderror" id="nama_makanan"
                        placeholder="Masukan Nama Menu" name="nama_makanan" value="{{ $makanan->nama_makanan }}">
                    @error('nama_makanan')
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control @error('qty_makanan') is-invalid @enderror" id="qty_makanan"
                        placeholder="Masukan Stok Menu" name="qty_makanan" value="{{ $makanan->qty_makanan }}">
                    @error('qty_makanan')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="file" @error('gambar_makanan') is-invalid @enderror id="gambar_makanan"
                        placeholder="Pilih Gambar" name="gambar_makanan" value="{{ $makanan->gambar_makanan }}">
