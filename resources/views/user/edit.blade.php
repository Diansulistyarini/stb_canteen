...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary text-center">Edit Users</h6>
        </div>
        <div class="card-body">
            <form class=" form-signin" action="/user/{{ $user->id_user }}" method="POST">
                @method('put')
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        ...
                        placeholder="Masukan Level" name="level" value="{{ $user->level }}">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control @error('password') is-invalid @enderror" id="password"
                        placeholder="Masukan Password" name="password" value="{{ $user->password }}">
                    @error('password')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
